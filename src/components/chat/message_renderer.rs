...
impl MessageRenderer for TextMessageRenderer {
    fn render(&self, ui: &mut Ui, message: &ChatMessage, style: &ChatMainStyle) {
...
impl MessageRenderer for FileMessageRenderer {
    fn render(&self, ui: &mut Ui, message: &ChatMessage, _style: &ChatMainStyle) {
        ui.add(Button::new(format!("📎 {}", &message.content)).frame(false));
    }
}

impl MessageRenderer for ImageMessageRenderer {
    fn render(&self, ui: &mut Ui, _message: &ChatMessage, _style: &ChatMainStyle) {
